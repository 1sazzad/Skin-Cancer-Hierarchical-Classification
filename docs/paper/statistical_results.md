...
Exact historical command: `.\.venv\Scripts\python.exe scripts/run_phase07_statistical_analysis.py --output-directory results/paper/statistics/phase07_generated --control-directory reports/phase07/control --report-path docs/paper/statistical_results.md`
